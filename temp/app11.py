...
if __name__ == "__main__":
    ...
    # 각 컨텐츠 리스트
    # tourism_item_list = (all_tourism_list[0]
    ...
    # 이미지 찾기 => url이 막힘
    # tourism_item = (tourism_item_list[0]
    #                 .find(name="div", attrs={"class": "poi"})
    #                 .find(name="a")
    #                 .find(name="div", attrs={"class": "prw_rup prw_common_centered_thumbnail"})
    #                 .find(name="div", attrs={"class": "sizing_wrapper"})
    #                 .find(name="div", attrs={"class": "centering_wrapper"})
    #                 .find(name="img")
    #                 )
